...
export default function ExampleItem({ example, parentRequest, onClick, onDelete, onRename, onDuplicate }: ExampleItemProps) {
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                    <ListItemText 
                        ...
                        primaryTypographyProps={{ variant: 'body2', fontSize: '11px', color: 'text.secondary', noWrap: true }}
                    />
